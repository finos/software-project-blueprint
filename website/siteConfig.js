...
const siteConfig = {
  ...
  headerLinks: [
    ...
    {doc: 'service-catalog', label: 'Use Cases'},
    {doc: 'finos-developer-identity', label: 'Get Involved'},
    {doc: 'service-catalog', label: 'Why Project Blueprint'},
    {blog: false}
  ],
  ...
  */
  ...
  copyright: `Copyright © ${new Date().getFullYear()} Project Blueprint`,  /* CHANGE THIS TO PROJECT / PROGRAM NAME */
